...
class TouristProfileInline(admin.StackedInline):
    ...
    extra = 0
    fields = ('bio', 'date_of_birth', 'nationality', 'preferred_language', 'profile_picture')
...
class GuideProfileInline(admin.StackedInline):
    ...
    extra = 0
    fields = ('bio', 'years_of_experience', 'languages', 'is_verified', 'verification_date', 
              'profile_picture', 'coverage_areas', 'half_day_price', 'full_day_price', 'extra_hour_price')

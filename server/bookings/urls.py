...
urlpatterns = [
    ...
    path(
        "<int:pk>/invoice/", views.BookingInvoiceView.as_view(), name="booking-invoice"
    ),
    path(
        "guide/pending/",
        views.GuidePendingBookingsView.as_view(),
        name="guide-pending-bookings",
    ),
    path(
        "tourist/upcoming/",
        views.TouristUpcomingBookingsView.as_view(),
        name="tourist-upcoming-bookings",
    ),
    path(
        "calendar/available/",
        views.GuideAvailabilityCalendarView.as_view(),

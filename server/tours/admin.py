...
class TourAdmin(admin.ModelAdmin):
    ...
    list_display = ['title', 'guide', 'wilaya', 'status', 'duration_hours', 'price', 
                    'max_group_size', 'bookings_count', 'image_preview', 'created_at']
    list_filter = ['status', 'wilaya', 'duration_hours', 'created_at']
    search_fields = ['title', 'description', 'guide__user__username', 'guide__user__first_name', 
                     'guide__user__last_name', 'wilaya__name_en', 'tags']
    readonly_fields = ['created_at', 'updated_at', 'slug', 'price', 'image_preview', 'bookings_count']
    filter_horizontal = []
    ordering = ['-created_at']
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('guide', 'title', 'description', 'slug')
        }),
        ('Location & Duration', {
            'fields': ('wilaya', 'meeting_point', 'latitude', 'longitude', 'duration_hours')
        }),
        ('Group & Pricing', {
            'fields': ('max_group_size', 'price')
        }),
        ('Services', {

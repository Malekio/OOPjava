...
class GuideProfile(models.Model):
    ...
    half_day_price = models.DecimalField(
        max_digits=10, decimal_places=2, help_text="Price for tours up to 4 hours"
    )
    full_day_price = models.DecimalField(
        max_digits=10, decimal_places=2, help_text="Price for tours 4-8 hours"
    )
    extra_hour_price = models.DecimalField(
        max_digits=10, decimal_places=2, help_text="Price per hour beyond 8 hours"
    )
...
class GuideAvailability(models.Model):
    ...
    guide = models.ForeignKey(
        GuideProfile, on_delete=models.CASCADE, related_name="availability_slots"
    )
...
class GuideCertification(models.Model):
    ...
    guide = models.ForeignKey(
        GuideProfile, on_delete=models.CASCADE, related_name="certifications"
    )

...
class TouristProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'nationality', 'preferred_language', 'created_at', 'profile_picture_preview']
    list_filter = ['nationality', 'preferred_language', 'created_at']
    search_fields = ['user__username', 'user__first_name', 'user__last_name', 'user__email', 'nationality']
...
class GuideProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'years_of_experience', 'verification_status', 'average_rating', 
                    'coverage_areas_count', 'created_at', 'profile_picture_preview']
    list_filter = ['verification_status', 'years_of_experience', 'created_at', 'coverage_areas']
    ...
    fieldsets = (
        ...
        ('Coverage & Pricing', {
            'fields': ('coverage_areas', 'half_day_price', 'full_day_price', 'extra_hour_price')
        }),
        ('Profile Picture', {
            'fields': ('profile_picture', 'profile_picture_preview')
        }),
...
class GuideCertificationAdmin(admin.ModelAdmin):
    ...
    search_fields = ['title', 'guide__user__username', 'guide__user__first_name', 'guide__user__last_name']
    readonly_fields = ['created_at']
    ordering = ['-created_at']
    
    fieldsets = (
        ('Certification Details', {
            'fields': ('guide', 'title', 'document')
        }),
        ('Verification Status', {
            'fields': ('is_verified',)
        }),
    ...
    def verify_certifications(self, request, queryset):
        ...
        self.message_user(request, f'{updated} certifications were verified successfully.')
